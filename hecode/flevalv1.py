...
# dp模型
# model.load_state_dict(torch.load('D:/ml/perflm/modelspeed/hemodel0903dp/global_model_round_20.pth'))

# dpdqn模型
model.load_state_dict(torch.load('D:/ml/perflm/hemodel0903dpdqn/global_model_round_3.pth'))
